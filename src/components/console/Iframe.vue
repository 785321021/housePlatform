<style scoped>
    ...
    .logo-img {
        padding: 10px 0 11px; display: block; text-align: center; background-color: #fff; box-shadow: 0 1px 1px rgba(0,0,0,.1); z-index: 1111;
    }
    .menu-avatar {
        text-align: right;
    }
...
<div class="layout">
    <Layout :style="{height:'100vh'}">
        <Sider breakpoint="md" collapsible :collapsed-width="78" v-model="isCollapsed" :style="{zIndex:'1'}">
            <div class="logo-img"><img src="/img/top.png" alt=""></div>
    ...
    <Layout>
                    ...
                    <Col span="6" :xs="0" :sm="6" class-name="menu-avatar">
                        <Dropdown @on-click="handleDropDownClick($event)">
                            <a href="javascript:void(0)">
                                <Avatar src="/img/avatar.png" /> {{ username }}
            ...
            <h4 class="f-l" :style="{color:'#515A6E',fontSize:'1.35rem',fontWeight:'normal'}">{{ title }}</h4>
                <div class="f-r">
...
<script>
    ...
    export default {
        ...
        created:function(){
            ...
            //     routeName = 'corpInfo-list';                
            // }
            var params = {'label':routeName};
